...
AccountSetting(
    ...
    Setting('setting_info', 'bio', null, 'markdown', 'Bio', null, FLAG_DISABLED | FLAG_HIDDEN),
    Setting('setting_info', 'school', '', 'text', 'School'),
    Setting('setting_info', 'realname', '', 'text', 'RealName'),
    Setting('setting_info', 'studentId', '', 'text', 'Student ID', null, FLAG_DISABLED | FLAG_HIDDEN),
    Setting('setting_info', 'phone', null, 'text', 'Phone', null, FLAG_DISABLED | FLAG_HIDDEN),
